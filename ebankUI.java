			...
			switch (choice) {
				...
				case 4:
					...
					System.out.println("Account successfully removed");
							...
							System.out.println("request denined");
						}
					}
					else {
			  ...
			  // ----------------------------------------------------------------------//done	
				...
				case 10 :
					...
					String test3 = cins.nextLine();
					
					test2 cp = ob1.find(test3);
